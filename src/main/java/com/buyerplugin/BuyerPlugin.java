 ...
 * - ShopData  — хранение данных склада байера (файл data.yml)
 * - ShopGUI   — обработчик графического интерфейса
 * - BuyerCommand — обработчик команды /buyer
 * - WeeklyResetTask — таймер сброса склада (каждые 60 секунд проверки)
 */
public class BuyerPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // 3. Создаём GUI и регистрируем как слушатель событий
